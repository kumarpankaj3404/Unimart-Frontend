...
// Added 'user' to props to access name and phone number
        ...
        <div className="bg-white w-full sm:max-w-md rounded-t-3xl sm:rounded-3xl p-6 shadow-2xl animate-slideUp">
          ...
          <div className="flex justify-between items-center mb-6">
            ...
            <button onClick={onBack} disabled={loading} className="disabled:opacity-50">
              <FiX size={22} className="text-[#14532D]" />
            </button>
          </div>

          <div className="bg-[#F0FDF4] rounded-2xl p-5 border border-[#22C55E]/20 relative overflow-hidden">
             <div className="absolute top-0 right-0 w-20 h-20 bg-[#16A34A]/5 rounded-bl-full -mr-4 -mt-4"></div>
            <div className="flex items-start gap-4 relative z-10">
              ...
              <div>
                {/* 1. Use User Name */}
                <p className="font-bold text-[#14532D] text-lg flex items-center gap-2">
                   {user?.name || "Customer"}
                ...
                {/* 2. Use 'fullAddress' from your Schema */}
                <p className="text-sm text-[#14532D]/70 mt-2 leading-relaxed">
                  {address.fullAddress}
                </p>

                {/* 3. Use User Number */}
                <p className="text-sm text-[#14532D]/80 font-medium mt-2 flex items-center gap-1">
          ...
          <div className="mt-8 space-y-3">
            ...
            <button
              onClick={onBack}
              disabled={loading}
              className="w-full py-3 border border-[#16A34A] text-[#16A34A] rounded-xl font-bold hover:bg-[#F0FDF4] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
              Change Address
            </button>
          </div>
