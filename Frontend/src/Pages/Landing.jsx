...
export default function Landing() {
    ...
    <div className="bg-[#F0FDF4] text-[#14532D] overflow-x-hidden selection:bg-[#22C55E] selection:text-white">
      ...
      <section className="pt-32 pb-16 max-w-7xl mx-auto px-6 flex flex-col lg:flex-row items-center gap-16">
        ...
        <div className="flex-1 fade-up">
          <span className="bg-[#22C55E]/20 text-[#14532D] px-5 py-2 rounded-full text-base font-medium">
            Fresh • Organic • Fast Delivery
          </span>

          <h1 className="mt-6 text-6xl lg:text-7xl font-extrabold leading-tight">
            Premium groceries, <br />
            <span className="text-[#16A34A]">delivered in minutes.</span>
          </h1>

          <p className="mt-5 text-[#14532D]/80 max-w-xl text-xl leading-relaxed">
  ...
  <div className="rounded-3xl overflow-hidden shadow-2xl border border-white/30 bg-linear-to-br from-[#CFFFE8] to-[#A7F3D0]">
    <video autoPlay muted loop playsInline className="w-full h-[350px] object-cover">
      ...
      <section className="py-16 bg-linear-to-b from-[#ECFDF3] to-[#F0FDF4]">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            ...
            <div className="p-8 bg-white rounded-xl shadow hover:shadow-xl transition fade-up">
              ...
              <p className="text-center text-[#14532D]/70 text-lg mt-2">
                Select groceries, fruits, vegetables & more with ease.
              </p>
            </div>

            <div className="p-8 bg-white rounded-xl shadow hover:shadow-xl transition fade-up delay-150">
            ...
            <div className="p-8 bg-white rounded-xl shadow hover:shadow-xl transition fade-up delay-300">
      ...
      <section className="py-16 bg-linear-to-b from-[#F0FDF4] to-[#ECFDF3] max-w-7xl mx-auto px-6">
  ...
  <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-8">
    {[
      ...
      <div
        key={c.name}
        className="rounded-2xl overflow-hidden bg-white shadow-md hover:shadow-xl transition group fade-up w-full h-[260px]"
      >
        <img
          src={c.img}
          alt={c.name}
        ...
        <div className="p-4 text-center">
          ...
          <div className="text-sm text-[#14532D]/70">Explore</div>
        </div>
      </div>
    ))}
  </div>
</section>
    <section className="py-20 bg-[#ECFDF3] relative overflow-hidden">

  <h3 className="text-5xl font-bold text-center mb-16 text-[#14532D]">
    Track Your Order — Live
  </h3>

  <div className="max-w-3xl mx-auto p-10 rounded-3xl bg-white/80 backdrop-blur-xl 
    ...
    <p className="text-center text-lg font-semibold text-[#14532D]/80 mb-6">
    ...
    <div className="grid grid-cols-3 text-center text-[#14532D] font-medium">

      <div className={`${idx >= 0 ? "text-[#16A34A]" : ""}`}>
        🛒 Packed <br />
        <span className="text-sm text-[#14532D]/60">Ready to go</span>
      </div>

      <div className={`${idx >= 1 ? "text-[#16A34A]" : ""}`}>
        🚚 On the Way <br />
        <span className="text-sm text-[#14532D]/60">Rider moving</span>
      </div>

      <div className={`${idx >= 2 ? "text-[#16A34A]" : ""}`}>
        📦 Delivered <br />
        <span className="text-sm text-[#14532D]/60">Almost there</span>
      </div>
  ...
  <footer className="relative bg-[#0f4227] text-white pt-16 pb-10 mt-20">
